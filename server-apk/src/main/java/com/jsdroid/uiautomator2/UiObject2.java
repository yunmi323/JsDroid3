...
public class UiObject2 implements Searchable {
     ...
     */
    public UiObject2(UiDevice device, AccessibilityNodeInfo cachedNode) {
        mDevice = device;
    ...
    public UiObject2 getParent() {
        ...
        return parent != null ? new UiObject2(mDevice, parent) : null;
    }
    ...
    public UiObject2 findObject(BySelector selector) {
        AccessibilityNodeInfo node =
                ByMatcher.findMatch(mDevice, selector, getAccessibilityNodeInfo());
        return node != null ? new UiObject2(mDevice, node) : null;
    }
    ...
    public List<UiObject2> findObjects(BySelector selector) {
        ...
        for (AccessibilityNodeInfo node :
            ...
            ret.add(new UiObject2(mDevice, node));
        }
    ...
    public void fastClick() {
        if (mCachedNode != null) {
            mCachedNode.performAction(AccessibilityNodeInfo.ACTION_CLICK);
        }
    }

    public void fastLongClick() {
        if (mCachedNode != null) {
            mCachedNode.performAction(AccessibilityNodeInfo.ACTION_LONG_CLICK);
        }
    }
